...
@testset "HTTP Requests" begin
    ...
    @testset "GET request" begin
        response = EasyCurl.get("httpbin.org/get", headers = headers, query = query, read_timeout = 30)
    ...
    @testset "HEAD request" begin
        response = EasyCurl.head("httpbin.org/get", headers = headers, query = query, read_timeout = 30)
        @test response.status == 200
    ...
    @testset "POST request" begin
        response = EasyCurl.post("httpbin.org/post", headers = headers, query = query, body = payload, read_timeout = 30)
        @test response.status == 200
    ...
    @testset "PUT request" begin
        response =
            EasyCurl.put("httpbin.org/put", headers = headers, query = query, body = payload, read_timeout = 30)
        @test response.status == 200
    ...
    @testset "PATCH request" begin
        response =
            EasyCurl.patch("httpbin.org/patch", headers = headers, query = query, body = payload, read_timeout = 30)
        @test response.status == 200
    ...
    @testset "DELETE request" begin
        response = EasyCurl.delete("httpbin.org/delete", headers = headers, query = query, body = payload, read_timeout = 30)
        @test response.status == 200
